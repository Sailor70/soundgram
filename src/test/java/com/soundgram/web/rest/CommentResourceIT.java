...
public class CommentResourceIT {
     ...
     *
     * @see com.soundgram.repository.search.CommentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.getTextContent()).isEqualTo(DEFAULT_TEXT_CONTENT);
    ...
    public void updateComment() throws Exception {
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getTextContent()).isEqualTo(UPDATED_TEXT_CONTENT);
